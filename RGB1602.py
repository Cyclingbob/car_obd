...
class RGB1602:
  ...
  def load_custom_char(self, slot, char_data):
    """Load a custom character into CGRAM."""
    # Set CGRAM address (LCD_SETCGRAMADDR | slot number shifted by 3)
    self.command(LCD_SETCGRAMADDR | (slot << 3))
    # Write the character data row by row (5x8 pixel grid)
